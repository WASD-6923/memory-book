...
return [
    ...
    */
    ...
    'namespaces' => [
        ...
        'queries' => [
            'App\\GraphQL\\Queries',
            'App\\GraphQL\\Queries\\Auth',
            'App\\GraphQL\\Queries\\Statistics',
        ],
        'mutations' => [
            'App\\GraphQL\\Mutations',
            'App\\GraphQL\\Mutations\\User',
            'App\\GraphQL\\Mutations\\Notification',
            'App\\GraphQL\\Mutations\\Statistics',
            'App\\GraphQL\\Mutations\\Meeting',
        ],
        'subscriptions' => [
            'App\\GraphQL\\Subscriptions',
            'App\\GraphQL\\Subscriptions\\Notification',
            'App\\GraphQL\\Subscriptions\\User',
        ],
    ...
    */
    ...
    'security' => [
        ...
        'disable_introspection' => (bool)env(
            ...
            false,
        ) ? GraphQL\Validator\Rules\DisableIntrospection::ENABLED : GraphQL\Validator\Rules\DisableIntrospection::DISABLED,
    ],
