...
return [
    ...
    */
    ...
    //'after'                => 'Превышен максимальный возраст',
    ...
    */
    ...
    'word_max_length' => 'Превышена допустимая длина слова.',
    'phone' => 'Неверный номер телефона.',
    'password.letters' => 'Требуется хотя бы одна буква',
    'password.mixed' => 'Требуется как минимум одна заглавная и одна строчная буква.',
    'password.symbols' => 'Требуется хотя бы один символ',
    'password.numbers' => 'Требуется хотя бы один номер',
];
